...
const property = "https://kidactivitylab.com/";
...
export function validatePublicSnapshot(snapshot, allowedUrls) {
  ...
  if (snapshot.visibility !== "public-summary" || snapshot.site !== "kid-activity-lab" || snapshot.property !== property) {
    throw new Error("Snapshot identity or visibility is invalid for the public Kid Activity Lab repository.");
  }
